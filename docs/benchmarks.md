...
Generated 2026-08-23 by `uv run python benchmarks/token_efficiency.py --write`.
...
- Tools registered: **42**
- Total schema surface: **25845 tokens** (103446 chars, 103738 bytes)
- Schema cost per tool: min 158, median 519, max 2440 tokens
- Median scenario response: **404 tokens** (range 87-540)
...
|---|---:|---:|---:|---:|
| `find_places` | 1805 | 539 | **2440** | 9760 |
...
| **all 42 tools** | 18438 | 4777 | **25845** | 103446 |

### Response cost (paid per tool call, measured on committed fixtures)

| scenario | question | response tokens | response chars |
|---|---|---:|---:|
| `find_places (point, 1km)` | What named places are within 1km of the fixture center? | **404** | 1618 |
| `find_places (point, category filter)` | Which coffee shops are within 1km? | **411** | 1646 |
