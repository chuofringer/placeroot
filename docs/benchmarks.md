...
- Tools registered: **41**
- Total schema surface: **22853 tokens** (91476 chars, 91726 bytes)
- Schema cost per tool: min 158, median 476, max 1459 tokens
- Median scenario response: **208 tokens** (range 87-811)
- Break-even: the schema surface costs about as much as **110 median answers**
...
| **all 41 tools** | 16399 | 3924 | **22853** | 91476 |
