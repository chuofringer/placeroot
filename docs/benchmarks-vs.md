...
- Schema surface, whole install (common fields): PlaceRoot **12411** tokens (28 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
- Schema surface, the six tools each server needs for the scenarios below (common fields): PlaceRoot **3686** · Mapbox **4654** (1.3x ours) · Google Maps **500** (5 tools — no isochrone tool exists)
- Whole-install surface: Mapbox is **1.2x** PlaceRoot's on common fields, on 29 tools against 28. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.4x (29295 against 12411), and 3.6x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 28 | 12411 | **12411** | 6 | 3686 | **3686** |
