...
- Schema surface, whole install (common fields): PlaceRoot **18788** tokens (37 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
- Schema surface, the six tools each server needs for the scenarios below (common fields): PlaceRoot **4176** · Mapbox **4654** (1.1x ours) · Google Maps **500** (5 tools — no isochrone tool exists)
- Whole-install surface: Mapbox is **0.8x** PlaceRoot's on common fields, on 29 tools against 37. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.6x (29295 against 18788), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 37 | 18788 | **18788** | 6 | 4176 | **4176** |
