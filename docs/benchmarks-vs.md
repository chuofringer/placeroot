...
- Schema surface, whole install (common fields): PlaceRoot **18290** tokens (36 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.8x** PlaceRoot's on common fields, on 29 tools against 36. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.6x (29295 against 18290), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 36 | 18290 | **18290** | 6 | 4176 | **4176** |
