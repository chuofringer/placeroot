...
- Schema surface, whole install (common fields): PlaceRoot **27752** tokens (42 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.5x** PlaceRoot's on common fields, on 29 tools against 42. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.1x (29295 against 27752), and 2.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 42 | 27752 | **27752** | 6 | 6339 | **6339** |
