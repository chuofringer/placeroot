...
- Schema surface, whole install (common fields): PlaceRoot **34029** tokens (42 tools) · Mapbox **28958** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.9x** PlaceRoot's on common fields (both sides' output schemas included), on 29 tools against 42. Verbatim — counting the rest of what each side sends beyond the common fields — it is 0.9x (29295 against 34029), and 1.6x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 42 | 34029 | **34029** | 6 | 8219 | **8219** |
