...
- Schema surface, whole install (common fields): PlaceRoot **14781** tokens (32 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.0x** PlaceRoot's on common fields, on 29 tools against 32. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.0x (29295 against 14781), and 3.3x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 32 | 14781 | **14781** | 6 | 3978 | **3978** |
