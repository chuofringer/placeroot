...
- Schema surface, whole install (common fields): PlaceRoot **14529** tokens (31 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.0x** PlaceRoot's on common fields, on 29 tools against 31. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.0x (29295 against 14529), and 3.3x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 31 | 14529 | **14529** | 6 | 3978 | **3978** |
