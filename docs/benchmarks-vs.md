...
- Schema surface, whole install (common fields): PlaceRoot **15926** tokens (34 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.0x** PlaceRoot's on common fields, on 29 tools against 34. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.8x (29295 against 15926), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 34 | 15926 | **15926** | 6 | 4176 | **4176** |
