...
- Schema surface, whole install (common fields): PlaceRoot **21363** tokens (40 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.7x** PlaceRoot's on common fields, on 29 tools against 40. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.4x (29295 against 21363), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 40 | 21363 | **21363** | 6 | 4198 | **4198** |
