...
- Schema surface, whole install (common fields): PlaceRoot **39835** tokens (48 tools) · Mapbox **28958** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.7x** PlaceRoot's on common fields (both sides' output schemas included), on 29 tools against 48. Verbatim — counting the rest of what each side sends beyond the common fields — it is 0.7x (29295 against 39835), and 1.5x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 48 | 39835 | **39835** | 6 | 8918 | **8918** |
