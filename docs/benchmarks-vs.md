...
- Schema surface, whole install (common fields): PlaceRoot **19761** tokens (38 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.8x** PlaceRoot's on common fields, on 29 tools against 38. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.5x (29295 against 19761), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 38 | 19761 | **19761** | 6 | 4176 | **4176** |
