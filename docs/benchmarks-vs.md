...
- Schema surface, whole install (common fields): PlaceRoot **17952** tokens (35 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.8x** PlaceRoot's on common fields, on 29 tools against 35. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.6x (29295 against 17952), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 35 | 17952 | **17952** | 6 | 4176 | **4176** |
