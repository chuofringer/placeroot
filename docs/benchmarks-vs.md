...
- Schema surface, whole install (common fields): PlaceRoot **23427** tokens (41 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.6x** PlaceRoot's on common fields, on 29 tools against 41. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.3x (29295 against 23427), and 2.8x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 41 | 23427 | **23427** | 6 | 4703 | **4703** |
