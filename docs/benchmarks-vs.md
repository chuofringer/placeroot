...
- Schema surface, whole install (common fields): PlaceRoot **13164** tokens (29 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.2x** PlaceRoot's on common fields, on 29 tools against 29. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.2x (29295 against 13164), and 3.4x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 29 | 13164 | **13164** | 6 | 3865 | **3865** |
