...
- Schema surface, whole install (common fields): PlaceRoot **15412** tokens (34 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.0x** PlaceRoot's on common fields, on 29 tools against 34. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.9x (29295 against 15412), and 3.3x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 34 | 15412 | **15412** | 6 | 3978 | **3978** |
