...
- Schema surface, whole install (common fields): PlaceRoot **14143** tokens (30 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.1x** PlaceRoot's on common fields, on 29 tools against 30. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.1x (29295 against 14143), and 3.3x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 30 | 14143 | **14143** | 6 | 3940 | **3940** |
