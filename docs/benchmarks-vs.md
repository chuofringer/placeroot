...
- Schema surface, whole install (common fields): PlaceRoot **13765** tokens (29 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
- Schema surface, the six tools each server needs for the scenarios below (common fields): PlaceRoot **3940** · Mapbox **4654** (1.2x ours) · Google Maps **500** (5 tools — no isochrone tool exists)
- Whole-install surface: Mapbox is **1.1x** PlaceRoot's on common fields, on 29 tools against 29. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.1x (29295 against 13765), and 3.3x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 29 | 13765 | **13765** | 6 | 3940 | **3940** |
