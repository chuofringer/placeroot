...
- Schema surface, whole install (common fields): PlaceRoot **22493** tokens (41 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.7x** PlaceRoot's on common fields, on 29 tools against 41. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.3x (29295 against 22493), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 41 | 22493 | **22493** | 6 | 4198 | **4198** |
