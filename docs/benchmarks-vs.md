...
- Schema surface, whole install (common fields): PlaceRoot **12590** tokens (28 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **1.2x** PlaceRoot's on common fields, on 29 tools against 28. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 2.3x (29295 against 12590), and 3.4x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 28 | 12590 | **12590** | 6 | 3865 | **3865** |
