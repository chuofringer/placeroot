...
- Schema surface, whole install (common fields): PlaceRoot **16465** tokens (35 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.9x** PlaceRoot's on common fields, on 29 tools against 35. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.8x (29295 against 16465), and 3.2x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 35 | 16465 | **16465** | 6 | 4085 | **4085** |
