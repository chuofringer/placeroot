...
- Schema surface, whole install (common fields): PlaceRoot **20515** tokens (39 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
...
- Whole-install surface: Mapbox is **0.7x** PlaceRoot's on common fields, on 29 tools against 39. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.4x (29295 against 20515), and 3.1x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 39 | 20515 | **20515** | 6 | 4198 | **4198** |
