...
- Schema surface, whole install (common fields): PlaceRoot **15458** tokens (34 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
- Schema surface, the six tools each server needs for the scenarios below (common fields): PlaceRoot **3978** · Mapbox **4654** (1.2x ours) · Google Maps **500** (5 tools — no isochrone tool exists)
- Whole-install surface: Mapbox is **1.0x** PlaceRoot's on common fields, on 29 tools against 34. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.9x (29295 against 15458), and 3.3x on the six-tool subset.
- Answers, over the 6 scenarios both PlaceRoot and Mapbox answer: PlaceRoot **1573** tokens total, Mapbox **1337** (1219 with pretty-print whitespace removed)
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 34 | 15458 | **15458** | 6 | 3978 | **3978** |
...
| `route_a_to_b` — Route from A to B. | **318** | **422** (text) | not measured |
