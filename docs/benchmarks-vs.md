...
- Schema surface, whole install (common fields): PlaceRoot **16421** tokens (35 tools) · Mapbox **15190** (29 tools) · Google Maps **655** (7 tools)
- Schema surface, the six tools each server needs for the scenarios below (common fields): PlaceRoot **4085** · Mapbox **4654** (1.1x ours) · Google Maps **500** (5 tools — no isochrone tool exists)
- Whole-install surface: Mapbox is **0.9x** PlaceRoot's on common fields, on 29 tools against 35. Verbatim — counting the output schemas Mapbox publishes and we don't — it is 1.8x (29295 against 16421), and 3.2x on the six-tool subset.
...
|---|---:|---:|---:|---:|---:|---:|
| PlaceRoot | 35 | 16421 | **16421** | 6 | 4085 | **4085** |
