...
for a day instead of re-reading a ~27.7k-token schema surface every session.
...
All 42 tool schemas cost roughly **27.7k tokens** of every conversation's
context, paid before the agent asks anything — about the cost of 63 median
