...
for a day instead of re-reading a ~25.1k-token schema surface every session.
...
All 42 tool schemas cost roughly **25.1k tokens** of every conversation's
