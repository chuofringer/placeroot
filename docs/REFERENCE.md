...
for a day instead of re-reading a ~16.5k-token schema surface every session.
...
All 35 tool schemas cost roughly **16.5k tokens** of every conversation's
